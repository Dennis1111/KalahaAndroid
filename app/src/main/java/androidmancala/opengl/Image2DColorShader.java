...
/**
 * Created by Dennis on 2016-01-15.
 */
public class Image2DColorShader {
    ...
    public Image2DColorShader()
    {
        ...
        if( mColorHandle == -1)
            Log.e(" MainShader", "a_Color not initialized");
